    ...
    if request.method == 'POST':
        ...
        if p_item_obj:
            if current_user.can_purchase(p_item_obj):
                ...
                flash(f'Congratulations! You successfully purchased {p_item_obj.name} for {p_item_obj.price}$', category='success')
            else:
        ...
        if s_item_obj:
            if current_user.can_sell(s_item_obj):
                ...
                flash(f'Congratulations! You successfully sold {s_item_obj.name} for {s_item_obj.price}$', category='success')
            else:
                flash(f'You do not own {p_item_obj.name}!', category='danger')
